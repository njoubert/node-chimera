...
#define QT_BUILD_KEY "macosx macx-cocoa g++-4 no-pkg-config QT_NO_STYLE_CDE QT_NO_STYLE_CLEANLOOKS QT_NO_STYLE_MOTIF QT_NO_STYLE_PLASTIQUE"
#define QT_BUILD_KEY_COMPAT "x86_64 Darwin g++-4 no-pkg-config QT_NO_STYLE_CDE QT_NO_STYLE_CLEANLOOKS QT_NO_STYLE_MOTIF QT_NO_STYLE_PLASTIQUE"
